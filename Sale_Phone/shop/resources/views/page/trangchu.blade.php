			...
			<div class="main-content">
				...
				<div class="row">
					<div class="col-sm-12">
						...
						<h4><img src="source/assets/dest/images/bootstrap-icons-1.1.0/gift.svg" alt="" width="30" height="30" title="New Gift">Bán chạy</h4>
								...
								<div class="col-sm-3">
									...
									@endif
										<div class="single-item-header">
											<a href="{{route('chitietsanpham', $new->id)}}"><img src="source/image/product/{{$new->image_cover}}" alt="" height="250px"></a>
										</div>
						...
						<div class="beta-products-list">
						<h4><img src="source/assets/dest/images/bootstrap-icons-1.1.0/star-fill.svg" alt="" width="30" height="30" title="Star Fill">Sản phẩm khác</h4>
							<div class="beta-products-details">
							...
							@foreach($sanpham_khuyenmai as $spkm)
								<div class="col-sm-3">
									...
									@if($spkm->promotion_price != 0)
										<div class="ribbon-wrapper"><div class="ribbon sale">Sale</div></div>
									@endif
										<div class="single-item-header" style="margin-top: 10px">
											<a href="{{route('chitietsanpham', $spkm->id)}}"><img src="source/image/product/{{$spkm->image_cover}}" alt="" height="250px"></a>
										</div>
										<div class="single-item-body">
											<p class="single-item-title"><b>{{$spkm->name}}</b></p>
											<p class="single-item-price" style="font-size: 13px">
											@if($spkm->promotion_price == 0)
