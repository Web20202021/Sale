								...
								<div class="col-sm-2" style="width:240px;margin-top: 10px;">
									...
									@endif
										<div class="single-item-header">
											<a href="{{route('chitietsanpham', $sp->id)}}"><center><img src="edit-product/upload/product/{{$sp->image_product}}" alt="" height="250px"></center></a>
										</div>
						...
						<div class="beta-products-list">
							...
							@foreach($sp_khac as $sp_k)
								<div class="col-sm-4">
									...
									@endif
										<div class="single-item-header">
											<a href="{{route('chitietsanpham', $sp_k->id)}}"><center><img src="edit-product/upload/product/{{$sp_k->image_product}}" alt="" height="250px"></center></a>
										</div>
										<div class="single-item-body">
