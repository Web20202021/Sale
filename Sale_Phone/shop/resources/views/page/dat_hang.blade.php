				...
				<div class="row">
					<div class="col-sm-6">
						...
						<div class="form-block">
							...
							<textarea id="notes" name="notes" placeholder="Nếu không có ghi chú nào thì hãy ghi tại đây là 'Không có'" value="Không có"></textarea>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="your-order">
							...
							<div class="your-order-body" style="padding: 0px 10px">
								<div class="your-order-item">
									...
									<!--  one item	 -->
										<div class="media">
											<img width="25%" src="source/image/product/{{$cart['item']['image_cover']}}" alt="" class="pull-left">
									...
									<div class="clearfix"></div>
								</div> <!-- Còn sai về giá cả ở giỏ hàng và đặt hàng -->
								<div class="your-order-item">
